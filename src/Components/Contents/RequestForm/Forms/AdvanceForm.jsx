...
export const AdvanceForm = () => {
  ...
  const descriptionChange = (e)=>{
    ...
    if (advancePayment.description.toLowerCase().includes("kredi kartı harcaması")){
    ...
    if (advancePayment.description.length > 20 && advancePayment.description.length < 200) {
      setDescriptionError(false)
    }else{
  ...
  return (
    <>
      ...
      <TextField
        ...
        helperText={amountError ? "Lütfen girilen değerin sayı olduğuna dikkat ediniz." : null}
        error={amountError}
        sx={{ marginBottom: 2, width: "20vw" }}
      />
      <FormControl  variant="outlined" sx={{ marginBottom: 2 , width: "8rem", marginLeft: "1rem" }}>
